...
\noindent\textbf{Metatheorie zu Frege et al.}
...
Diese Thesen geht Kripke Schritt f"ur Schritt durch und zeigt dass sie nicht gelten k"onnen.
...
\begin{description}[leftmargin=!,labelwidth=\widthof{\bfseries (B)}]
    ...
    \item[Deskritivistische Auffassungen von Namen]  Jeder Name hat eine \emph{Bedeutung}.
    \item[Bild der Sprache]
    \item[   ] blablabla
    \item[heck ] blablabla
\end{description}
