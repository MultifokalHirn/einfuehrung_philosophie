...
\dictum[Alain Badiou]{%
My wish for the youth is that they tra­verse these four con­di­tions: to encoun­ter art in all its forms; to be lov­ing in fidel­ity, and for a long time; and to par­ti­cip­ate in the polit­ical recon­struc­tion of a world of justice, as against the world such as it is. And not to be as ignor­ant of sci­ence as they cur­rently are, so that they do not leave it in the hands of tech­no­logy or cap­ital.}
\vspace{15pt}

\begin{itemize}
\item what is h: priciples of interpretation
\item h has history (has not always been there)
\end{itemize}
