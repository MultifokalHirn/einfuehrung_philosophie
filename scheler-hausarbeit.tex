...
%Das Problem, um das es hier für die Erkenntnistheorie geht, ist die basale Frage nach dem Verhältnis von Mensch und "`Außenwelt"'. Wie 
...
Des weiteren habe ich den Einwand zu Option (a) gehört, dass der Leib ja möglicher\-weise zu Beginn punktförmig sei und sich stetig ausdehnen würde. Da dieser Einwand der von Scheler aufgeführten Zirkularität jedoch nicht entkommt, ist er aber nicht weiter zu beachten.
