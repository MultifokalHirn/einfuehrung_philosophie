...
\bigletter{O}
\term{Ontologie}{Die Lehre vom Seienden: Was gibt es? Woraus besteht/Was ist die Welt? Welche Ursubstanzen der Welt gibt es? [Siehe z.B. Res Cogitans, Res Extensa]}
...
\term{Survivorship Bias}{Survivorship Bias (Verzerrung zugunsten der Überlebenden) bezeichnet einen Fehlschluss: Da erfolgreiche "`Überlebende"' im Alltag eine größere Sichtbarkeit erzeugen als erfolglose "`Verstorbene"', neigt man systematisch dazu, die Erfolgsaussichten zu überschätzen.}
